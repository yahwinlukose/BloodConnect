...
public class DonorProfileUpdateRequest {
    ...
    public DonorProfileUpdateRequest(String bloodGroup, String gender, String dateOfBirth, String location, Double latitude, Double longitude, Boolean isAvailable, String lastDonationDate) {
